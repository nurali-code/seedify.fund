              ...
              <div class="style_bannerContainer__fsR7K">
                  <div class="style_subBannerContainer__zbJS8">
                      <div class="style_imageContainer__zlhyQ">
                          <img src="${data.image}" alt="Project thumbnail" height="128" width="128">
                      </div>
                      <div class="style_statusContainer__ZGW8P">
                          <div class="style_subStatusContainer__2pWHE">
                              <div class="">
              ...
              <div class="style_secondContainer__xxX7C">
                  <div class="style_descriptionContainer__yBWnK">
                      ...
                      <section>
                          <p class="style_description__2cdWs">
                              ${data.text}
                              <a href="${data.link}" rel="noopener noreferrer" target="_blank">View More</a>
                          </p>
                      </section>
                  </div>
                  <div class="style_tokenPriceContainer__oxmP0">
                      ...
                      <div class="style_tokenPriceSubContainer__pr8_T">
                          <img alt="token" src="${data.token}" width="30" height="30" loading="lazy">
                  ...
                  <div class="style_bigInfoContainer__K9lzc">
                      ...
                      <div class="style_buttonContainer__9HHN2">
                      <a href="${data.link}" type="button" class="style_button__fU377 style_active__Ssu_U style_lg__gcLqO"><span>Register</span></a>
                      </div>
                  </div>
              </div>
          </div>
